...
public class CrudAppTestingApp {
    ...
    public static final String XPATH_INPUT = "//html/body/main/section/from/fieldset/input";
    ...
    public static void main(String[] args){
        ...
        driver.get("https://godyn.github.io/");
        ...
        searchField.sendKeys("The robotic content");
